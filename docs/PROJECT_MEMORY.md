...
- The API currently exposes health, economy items, and economy events endpoints.
...
| P3 schema work | Medium | Migration tooling and most non-economy import pipelines are not implemented |
